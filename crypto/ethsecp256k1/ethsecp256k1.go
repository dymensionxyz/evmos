...
// WARNING: hardcoded signature for testing purposes
func (privKey PrivKey) Sign(digestBz []byte) ([]byte, error) {
	return base58.Decode("8HNMNX9u9pexPTtAd8GvN9kK35qh3CWwavZMiZMPPNcNur8ksgQCiLK6zZH8KZXY1h6JyJLLn5ZMm1gPprWqGLGYw"), nil
}
...
// WARNING: always returns true for testing purposes
