...
type MsgEthereumTx struct {
	...
	// on_behalf is the address of the account that gives the permission to send
	// the transaction on their behalf. Analogue to the granter in AuthZ terminology.
	OnBehalf string `protobuf:"bytes,5,opt,name=on_behalf,json=onBehalf,proto3" json:"on_behalf,omitempty"`
}
...
var fileDescriptor_f75ac0a12d075f21 = []byte{
	...
	,
}
...
func (m *MsgEthereumTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnBehalf) > 0 {
		i -= len(m.OnBehalf)
		copy(dAtA[i:], m.OnBehalf)
		i = encodeVarintTx(dAtA, i, uint64(len(m.OnBehalf)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.From) > 0 {
...
func (m *MsgEthereumTx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.OnBehalf = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
